...
public class MineSweeper {
    ...
    public static void main(String[] args) {
        //create an obj belonging to class
    ...
    public void startGame(){
        ...
        //setup minesweeper field
        setupField(1);

        boolean flag = true;
        //run game until player wins/loses
        while(flag){
            displayVisible();
            flag = playMove();
    ...
    public void setupField(int diff){
        int var = 0;
        while(var != 10){
            //choose random int from 0-9 for row and col & place bomb in location
